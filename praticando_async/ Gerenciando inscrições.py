"""
Paula trabalha em uma plataforma de ensino online e precisa garantir que os alunos sejam inscritos corretamente 
nos cursos desejados. O sistema deve seguir as seguintes regras:
...
A lista de alunos e os cursos disponíveis já está definida no sistema. Lembre-se de processar múltiplas inscrições em paralelo. 
Confira o código:
