...
notas = input("Digite as notas dos alunos separadas por vírgula: ").strip().replace(",", "").split()
media = 0
for nota in notas:
    media += float(nota)

print(f"Média final da turma: {media/len(notas):.2f}")

"""
Código deles, os 2 funcionam mas achei o deles melhor então salvei aqui.
