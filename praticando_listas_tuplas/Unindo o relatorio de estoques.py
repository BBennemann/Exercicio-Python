...
estoque1 = tuple(input("Produtos do estoque 1 (separados por vírgula): ").strip().lower().split(sep=", "))
estoque2 = tuple(input("Produtos do estoque 2 (separados por vírgula): ").strip().lower().split(sep=", "))

estoque_geral = estoque2 + estoque1

print(f"Estoque combinado: {estoque_geral}")
