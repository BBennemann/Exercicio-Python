...
permissoes = set(input("permissões principais: ").lower().split(sep=', '))
permissoesSolicitadas = set(input("permissões solicitadas: ").lower().split(sep=', '))

if permissoesSolicitadas.difference(permissoes):
